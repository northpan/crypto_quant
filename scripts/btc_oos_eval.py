...
def compute_single_factor_backtest_ret(factor_series, forward_return, ic, forward_period, n_quantiles=5):
...
def main():
    ...
    test_5 = pool.test(factors_in[valid], forward_5_in, n_quantiles=5, verbose=False)
    ...
    def _composite_ret(factor_df, fwd, ic_series, period):
        ...
        return compute_single_factor_backtest_ret(comp, fwd, 1.0, period, 5)
    ...
    if len(common_cols) < 5:
        ...
        oos_ret_5 = compute_single_factor_backtest_ret(comp_5, forward_5_oos, 1.0, 5, 5)
        oos_ret_60 = compute_single_factor_backtest_ret(comp_60, forward_60_oos, 1.0, 60, 5)
